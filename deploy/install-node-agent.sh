...
NODE_AGENT_BIND_HOST=0.0.0.0
NODE_AGENT_BIND_PORT=9000
NODE_AGENT_ADVERTISE_ADDR=127.0.0.1:9000
# Optional explicit VM pool budget. Leave unset to use full physical host totals.
# NODE_AGENT_ALLOCATABLE_VCPU=8
# NODE_AGENT_ALLOCATABLE_RAM_MB=16384
# Optional host-stats sampler interval in seconds.
# NODE_AGENT_HOST_STATS_INTERVAL_SEC=2
...
echo "Generated defaults: NODE_AGENT_SERVICE_MANAGER=$NODE_AGENT_SERVICE_MANAGER NODE_AGENT_NETWORK_BACKEND=$NODE_AGENT_NETWORK_BACKEND NODE_AGENT_BIND_HOST=0.0.0.0 NODE_AGENT_BIND_PORT=9000"
if [ -n "$NODE_AGENT_PIP_CONSTRAINT" ]; then
